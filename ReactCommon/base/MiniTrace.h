...
extern double between_bridge_create_and_run_bundle_js;
...
#define MTR_ENABLED
#define MTR_COPY_EVENT_CATEGORY_AND_NAME
...
#define MTR_SCOPE(c, n) facebook::react::MTRScopedTrace ____mtr_scope(c, n)
